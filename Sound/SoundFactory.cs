...
public class SoundFactory
{
    ...
    public void LoadAllContent(ContentManager Content)
    {
        if (!soundEffects.ContainsKey("Dungeon 1"))
        {
            ...
            soundEffects.Add("LOZ_Bomb_Drop", Content.Load<SoundEffect>("Sound2/LOZ_Bomb_Drop"));// not functional
            ...
            soundEffects.Add("LOZ_Fanfare", Content.Load<SoundEffect>("Sound2/LOZ_Fanfare"));//Done
            soundEffects.Add("LOZ_Get_Heart", Content.Load<SoundEffect>("Sound2/LOZ_Get_Heart"));//done
            soundEffects.Add("LOZ_Get_Item", Content.Load<SoundEffect>("Sound2/LOZ_Get_Item"));//done, tested
            soundEffects.Add("LOZ_Get_Rupee", Content.Load<SoundEffect>("Sound2/LOZ_Get_Rupee"));//done
